...
class SoapClient extends \SoapClient
{
    ...
    public function __construct($wsdl, $requestType, $options = null, $rwLogger)
    {
    ...
    public function rwLogger($req, $res)
    {
        ...
        if (isset($res['artifact-data']['image'])) {
            unset($res['artifact-data']['image']);
        }

        $reqRes = array("Request" => $req, "Response" => $res);
